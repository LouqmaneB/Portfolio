...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(e,t,n){let r=new Float32Array(_o),i=new q(0,1,0);return new Ji({name:`SphericalGaussianBlur`,defines:{n:_o,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(){return new Ji({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function No(){return new Ji({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Po(),fragmentShader:`
	...
	`}var Fo=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Pi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Qs(i,i.VERTEX_SHADER,y),S=Qs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=ic(i,x,`vertex`),n=ic(i,S,`fragment`);H(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
  ...
  `,document.body.appendChild(e);let t=document.getElementById(`modal-video`),n=document.getElementById(`modal-title`),r=document.getElementById(`modal-description`),i=document.getElementById(`modal-cta`),a=e.querySelector(`.modal-close`),o=e.querySelector(`.modal-close-icon`),s=null;function c(a,o,c,l,u){s&&!s.paused&&s.pause(),s=u,t.src=a,t.load(),t.play().catch(e=>console.log(`Modal video play error:`,e)),n.textContent=o,r.textContent=c,l===`_blanc`||!l||l===`#`?(i.removeAttribute(`href`),i.style.opacity=`0.5`,i.style.cursor=`not-allowed`,i.textContent=`Coming Soon`):(i.href=l,i.style.opacity=`1`,i.style.cursor=`pointer`,i.style.pointerEvents=`auto`,i.textContent=`View Project →`),e.classList.add(`active`),document.body.style.overflow=`hidden`}function l(){e.classList.remove(`active`),t.pause(),t.src=``,document.body.style.overflow=``,s&&s.paused===!1&&s.play().catch(e=>console.log(`Resume video error:`,e)),s=null}a.addEventListener(`click`,l),o.addEventListener(`click`,l),e.addEventListener(`click`,t=>{t.target===e&&l()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&e.classList.contains(`active`)&&l()}),e.addEventListener(`click`,t=>{t.target===e?l():t.stopPropagation()});function u(e,t){n.textContent=e,r.textContent=t}return{open:c,update:u}}var Gl=new URL(`data:application/json;base64,`,``+import.meta.url),Kl=`en`,ql={lang:localStorage.getItem(`preferredLang`)||Kl,currentProject:null},Jl={},Yl;async function Xl(){let e=await fetch(Gl);if(!e.ok){console.error(`Failed to load translations`);return}Jl=await e.json();let t=document.querySelectorAll(`input[name="language"]`),n=document.querySelectorAll(`[data-i18n-key]`),r=document.querySelector(`.lang-slider`);function i(e){return e.translations?.[ql.lang]||e.translations?.[Kl]}function a(){if(!ql.currentProject)return;let e=i(ql.currentProject);Yl.update?.(e?.title,e?.description)}function o(e){Jl.translations[e]||(e=Kl),ql.lang=e,localStorage.setItem(`preferredLang`,e),n.forEach(t=>{let n=t.dataset.i18nKey;t.textContent=Jl.translations[e]?.[n]||``}),document.documentElement.lang=e,t.forEach(t=>{t.checked=t.value===e}),r&&(r.style.transform=e===`de`?`translateX(100%)`:`translateX(0)`),a()}t.forEach(e=>{e.addEventListener(`change`,e=>{o(e.target.value)})}),o(ql.lang)}var Zl=new Mn,Ql=new Ea(60,window.innerWidth/window.innerHeight,.1,1e3);Ql.position.set(-15,12,70);var $l=new vl({antialias:!0});$l.setSize(window.innerWidth,window.innerHeight),$l.setPixelRatio(Math.min(window.devicePixelRatio,2)),$l.setClearColor(330522),document.body.appendChild($l.domElement);var eu=30,tu=Vl(Zl,eu);Yl=Wl();var{group:nu}=Ul(Zl,eu,(e,t)=>{ql.currentProject=e;let n=e.translations?.[ql.lang]||e.translations?.[Kl];Yl.open(e.videoSrc||e.img,n?.title,n?.description,e.link,t)});Xl();var ru=new Ol(Ql,$l.domElement);ru.enableZoom=!0,ru.enablePan=!0;var iu=new Xa,au=new K,ou=null,su=0;window.addEventListener(`mousemove`,e=>{au.x=e.clientX/window.innerWidth*2-1,au.y=-(e.clientY/window.innerHeight)*2+1,iu.setFromCamera(au,Ql);let t=iu.intersectObjects(nu.children);ou=t.length>0?t[0].object:null}),window.addEventListener(`click`,e=>{au.x=e.clientX/$l.domElement.clientWidth*2-1,au.y=-(e.clientY/$l.domElement.clientHeight)*2+1,iu.setFromCamera(au,Ql);let t=iu.intersectObjects(nu.children,!0);if(t.length>0){let e=t[0].object.userData.ele;ql.currentProject=e;let n=e.translations?.[ql.lang]||e.translations?.[Kl];Yl.open(e.img,n?.title,n?.description,e.link,e.img)}}),window.addEventListener(`wheel`,e=>{su+=e.deltaY*.001}),window.addEventListener(`resize`,()=>{Ql.aspect=window.innerWidth/window.innerHeight,Ql.updateProjectionMatrix(),$l.setSize(window.innerWidth,window.innerHeight)});function cu(){nu.rotation.y+=(su-nu.rotation.y)*.1,nu.children.forEach(e=>{if(e.material){e.material.transparent=!0;let t=ou===null||e===ou?1:.4;e.material.opacity+=(t-e.material.opacity)*.1}});let e=Date.now()*.002;tu.stars.rotation.y+=3e-4,tu.stars.rotation.x+=2e-4;let t=tu.particles.geometry.attributes.position.array;for(let e=0;e<tu.particleCount;e++)t[e*3+1]+=tu.particleVelocities[e].y,t[e*3]+=tu.particleVelocities[e].x,t[e*3+2]+=tu.particleVelocities[e].z,t[e*3+1]>15&&(t[e*3+1]=-15,t[e*3]=(Math.random()-.5)*60,t[e*3+2]=(Math.random()-.5)*40);tu.particles.geometry.attributes.position.needsUpdate=!0,tu.colorLight1.intensity=.25+Math.sin(e)*.15,tu.colorLight2.intensity=.25+Math.cos(e*1.3)*.15,tu.colorLight1.position.x=5+Math.sin(e)*1.5,tu.colorLight2.position.z=10+Math.cos(e*.8)*2,tu.rimLight.intensity=.4+Math.sin(e*1.8)*.15,tu.flare&&tu.flare.lookAt(Ql.position),$l.render(Zl,Ql),requestAnimationFrame(cu)}cu();